        ...
        <tr>
            <td align="center" valign="middle">
                ...
                <div style="position:relative;width:100%">
                    ...
                    <div id="dlg_newbug" class="easyui-dialog"
                         style="width:75%;height:500px;left:15%;top:10%;padding:10px 20px"
                        ...
                        <form id="fm_newbug" method="post" enctype="multipart/form-data" novalidate>
                            <div class="fitem">
                                <label>请选择项目:</label>
                                <select id="projectselect_newbug" name="projectselect_newbug"
                                        data-options="required:true" class="easyui-combobox" panelHeight="auto"
                                        style="width:100px">
                                    @foreach($data as $d)
                                        echo "
                                        <option value="{{$d->pid}}">{{$d->pname}}</option>";
                                ...
                                <div class="fitem">
                                    <label>bug标题:</label>
                                    <input name="btitle" class="easyui-textbox" style="width:90%;resize:none;"
                                           data-options="required:true"/>
                                </div>
                                <div class="fitem">
                                    <label>bug详情:</label>
                                    <textarea name="bdescription" class="easyui-textbox"
                                ...
                                <div style="margin-bottom:20px">
                                    ...
                                    <img id="edit_photo1" name="edit_photo1" width="40%" src=""
                                         onclick="javascript:showImg(src)" style="display:none;">
                                ...
                                <div style="margin-bottom:20px">
                                    ...
                                    <img id="edit_photo2" name="edit_photo1" width="40%" src=""
                                         onclick="javascript:showImg(src)" style="display:none;">
                    ...
                    <div id="dlg-buttons-new">
                        ...
                        <a href="#" class="easyui-linkbutton" iconCls="icon-cancel"
                           onclick="javascript:$('#dlg_newbug').dialog('close')">取消</a>
                    </div>
                </div>
            </td>
        </tr>
