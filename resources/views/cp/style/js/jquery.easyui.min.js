...
$.fn.pagination.defaults={total:1,pageSize:50,pageNumber:1,pageList:[50,100,150,200],loading:false,buttons:null,showPageList:true,showRefresh:true,links:10,layout:["list","sep","first","prev","sep","manual","sep","next","last","sep","refresh"],onSelectPage:function(_d1,_d2){
},onBeforeRefresh:function(_d3,_d4){
},onRefresh:function(_d5,_d6){
},onChangePageSize:function(_d7){
},beforePageText:"页数",afterPageText:"第 {pages} 页",displayMsg:"显示 {from} 到 {to} 总共 {total} 项",nav:{first:{iconCls:"pagination-first",handler:function(){
