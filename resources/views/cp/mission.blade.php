...
@section('content')
    <table width="100%"><tr><td align="center" valign="middle">
                <table id="dg_mission_cp" title="我的任务" class="easyui-datagrid" style="width:100%"
                       url="{{url('cp/getmission')}}?_token={{csrf_token()}}"
                    ...
                    <div id="dlg_mission_new" class="easyui-dialog" style="width:600px;height:500px;left:25%;top:10%;padding:10px 20px"
                        ...
                        <form id="fm_mission_new" method="post"  enctype="multipart/form-data" novalidate>
                            ...
                            <div style="margin-bottom:20px">
                                ...
                                <input name="application" class="easyui-textbox" size="50" type="text" readOnly="true"
                                       data-options="prompt:'选择要上传的apk...'"/>
                    ...
                    <div id="dlg_mission_edit" class="easyui-dialog" style="width:600px;height:500px;left:25%;top:10%;padding:10px 20px"
                        ...
                        <form id="fm_mission_edit" method="post"  enctype="multipart/form-data" novalidate>
                            ...
                            <div style="margin-bottom:20px">
                                ...
                                <input name="application" class="easyui-textbox" size="50" type="text" readOnly="true"
                                       data-options="prompt:'选择要上传的apk...'"/>
                                <input id="file_upload_edit" name="file_upload" type="file" multiple="true">
                            </div>
                        </form>
                    </div>
